...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=str, help="Output directory for audio files", default="audio"
    )

    subparser = parser.add_subparsers(dest="command")

    subparser.add_parser("constellations", help="Generate audio files for constellations")
